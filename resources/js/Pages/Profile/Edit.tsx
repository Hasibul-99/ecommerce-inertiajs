...
import {
    FiUser, FiLock, FiAlertTriangle, FiShoppingBag, FiHeart,
    FiMapPin, FiGrid, FiMail, FiCheck, FiEye, FiEyeOff, FiTrash2,
} from 'react-icons/fi';
                        ...
                        <div className="bg-white border border-grabit-border rounded-lg p-6">
                            ...
                            <nav className="space-y-2">
                                <Link href="/dashboard" className={navLinkClass('/dashboard')}>
                                    <FiGrid className="w-5 h-5" /><span>Dashboard</span>
                                </Link>
                                <Link href="/orders" className={navLinkClass('/orders')}>
                                    <FiShoppingBag className="w-5 h-5" /><span>My Orders</span>
                                </Link>
                                <Link href="/wishlist" className={navLinkClass('/wishlist')}>
                                    <FiHeart className="w-5 h-5" /><span>Wishlist</span>
                                </Link>
                                <Link href="/addresses" className={navLinkClass('/addresses')}>
                                    <FiMapPin className="w-5 h-5" /><span>Addresses</span>
                                </Link>
                                <Link href="/profile" className={navLinkClass('/profile')}>
                                    <FiUser className="w-5 h-5" /><span>Account Settings</span>
                                </Link>
                            </nav>
                        </div>
                    </aside>
