                    ...
                    <CardContent className="pt-10 pb-8 px-8 text-center">
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="relative flex items-center justify-center">
                                <div className="absolute w-28 h-28 bg-brand-100 dark:bg-brand-900/20 rounded-full animate-ping opacity-20" />
                                <div className="relative w-20 h-20 bg-gradient-to-br from-brand-100 to-brand-50 dark:from-brand-900/40 dark:to-brand-800/20 rounded-full flex items-center justify-center shadow-lg shadow-brand-100 dark:shadow-brand-900/20">
                                    <FiSearch className="w-9 h-9 text-brand-500 dark:text-brand-400" />
                                </div>
                            </div>
                        </div>
