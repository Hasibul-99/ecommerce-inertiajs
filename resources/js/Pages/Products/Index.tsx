                    ...
                    <main className="lg:w-3/4">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                            ...
                            <div className="flex items-center gap-2 w-full sm:w-auto">
                                ...
                                <select
                                    ...
                                    className="flex-1 sm:flex-initial border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                                >
                        ...
                        {products.data.length > 0 ? (
                            ...
                            <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
                                ...
                                <Link
                                    href="/products"
                                    className="inline-block bg-brand-600 hover:bg-brand-700 text-white px-6 py-2 rounded-md transition-colors"
                                >
                                    Clear All Filters
                                </Link>
                            </div>
