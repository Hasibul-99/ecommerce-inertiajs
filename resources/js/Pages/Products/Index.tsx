...
export default function ProductsIndex({
  ...
  const [sortBy, setSortBy] =
    useState();
    // safeFilters?.sort ? safeFilters?.sort : "",
      ...
      <div className="bg-grabit-bg-light py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-grabit-gray">
            <Link href="/" className="hover:text-grabit-primary">
              Home
            </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-1/4">
            <div className="bg-white border border-grabit-border rounded-lg p-6 sticky top-24">
              <h2 className="text-lg font-heading font-semibold text-grabit-dark mb-4">
                Filters
              </h2>
              ...
              {categories.length > 0 && (
                <div className="mb-6">
                  <h3 className="font-medium text-grabit-dark mb-3 pb-3 border-b">
                    Categories
                  </h3>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 bg-grabit-bg-light p-3 rounded">
                    <div className="flex-1">
                      <label className="text-xs text-grabit-gray block mb-1">
                        Min
                      </label>
                      <input
                        type="number"
            ...
            <div className="bg-white border border-grabit-border rounded-lg p-4 mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-grabit-gray">
                  Showing {safeProducts.from}-{safeProducts.to} of{" "}
                  {safeProducts.total} products
                </span>
              </div>
