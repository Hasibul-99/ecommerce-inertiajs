    ...
    public function show(Order $order)
    {
        ...
        $formattedOrder = [
            ...
            'shipping_address' => $order->shippingAddress ? [
                ...
                'address_line1' => $order->shippingAddress->address_line_1,
                'address_line2' => $order->shippingAddress->address_line_2,
            ...
            'billing_address' => $order->billingAddress ? [
                ...
                'address_line1' => $order->billingAddress->address_line_1,
                'address_line2' => $order->billingAddress->address_line_2,
